...
def resnet34(modality, progress=True, **kwargs):
    return _resnet('resnet34', BasicBlock, [3, 4, 6, 3], modality, progress,
                   **kwargs)

def resnet50(modality, progress=True, **kwargs):
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], modality, progress,
                   **kwargs)